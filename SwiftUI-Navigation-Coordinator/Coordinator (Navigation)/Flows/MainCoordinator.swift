...
private extension MainCoordinator {
    ...
    func showingTabBarView() {
        ...
        let tabBarControlers = UITabBarController()
        tabBarControlers.setViewControllers(controllers, animated: false)
        
        presenter.setViewControllers([tabBarControlers], animated: true)
